...
pub trait DevPustaczekVaxtify {
	fn browser_register(&self, pid: i64) -> Result<(), dbus::Error>;
	fn browser_tab_delete(&self, pid: i64, tab: i64) -> Result<(), dbus::Error>;
	fn browser_tab_update(&self, pid: i64, tab: i64, url: &str) -> Result<(), dbus::Error>;
	fn browser_unregister(&self, pid: i64) -> Result<(), dbus::Error>;
